...
| Revenue Growth | +18.6% | +10.07% | -8.5pp |
| Gross Margin | 59.6% | 58.5% | -110bps |
...
### Customer Profile
- **Gender**: 63% women, 70% female customers
- **Age**: Primary 25-34, target 18-49 (50%)
- **Income**: $100K+ household
- **Digital**: 50% of revenue
- **Loyalty**: 45% program participation (opportunity)

### Marketing ROI Champions
1. **Micro-Influencers**: 7.3x ROI (7.3% engagement)
2. **Podcasts**: 4.9x ROI (62% trust, 86% brand recall)
3. **Influencer Average**: 5.2x ROI
4. **Social Media**: 3.6x ROI (15% trust)
...
### What's Happening
- Stock collapsed 66% (peak to present)
- Revenue growth halved (18.6% → 5.5% projected)
- Gross margins compressed (110 basis points)
- Americas sales down 5% (latest quarter)

### Why It's Happening
1. **Vuori Growth**: 550% customer penetration growth (1.2% → 7.8%)
2. **Alo Yoga Rise**: Teen ranking jumped 35th → 11th in 12 months
3. **Product Failure**: Brand "too predictable," Gen Z shifting to baggy fits
4. **Inventory Crisis**: Core leggings in outlets, massive clearance pressure
...
|--------|------|------|------|
| Athleisure | $431.7B | $1,069.8B | 9.5% |
...
|-------|----------|-------------|
| Lululemon | Premium performance | $98-$118 (Align pant) |
| Vuori | Mid-premium comfort | $98 (AllTheFeels) |
| Alo Yoga | Fashion-forward yoga | Comparable to Vuori |
| Nike | Scale & breadth | Varied product range |
...
- Fitness influencers: 18.36% engagement (highest)
- Micro-influencers (10-50K): 7.3% engagement, 60% higher CTR
- Nano-influencers: Better ROI (56% of marketers report)
- CPM reduced 53% from 2023 ($4.63 avg)

### Podcast Performance
- Host-read ads: 62% trust, 86% brand recall
- Conversion rate: 1.5-5% (fitness likely 3-5%)
- 55% of listeners purchased after podcast ad
...
### Americas (74% of revenue)
- Down 5% comp sales (Q3 FY2025)
- Down 4% comp sales (Q2 FY2025)
